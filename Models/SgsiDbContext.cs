...
public class SgsiDbContext : DbContext
{
    ...
    public DbSet<CenarioAtual> CenarioAtual { get; set; } // Tabela: CENARIO
    public DbSet<CenarioFuturo> CenarioFuturo { get; set; } // Tabela: CENARIO_FUTURO
    ...
    {
        // Mapeamento para CenarioAtual (tabela CENARIO)
        modelBuilder.Entity<CenarioAtual>(entity =>
        {
            entity.ToTable("CENARIO", "SGSI");
            entity.HasKey(e => e.ID);
            entity.Property(e => e.ID).HasColumnName("ID");
            entity.Property(e => e.JUSTIFICATIVA).HasColumnName("JUSTIFICATIVA");
            entity.Property(e => e.PRIOR_ATUAL).HasColumnName("PRIOR_ATUAL");
            entity.Property(e => e.STATUS_ATUAL).HasColumnName("STATUS_ATUAL"); // ✅ CORRIGIDO
            entity.Property(e => e.POLIT_ATUAL).HasColumnName("POLIT_ATUAL");
            entity.Property(e => e.PRAT_ATUAL).HasColumnName("PRAT_ATUAL");
            entity.Property(e => e.FUNC_RESP).HasColumnName("FUNC_RESP");
            entity.Property(e => e.REF_INFO).HasColumnName("REF_INFO");
            entity.Property(e => e.EVID_ATUAL).HasColumnName("EVID_ATUAL"); // ✅ CORRIGIDO
            entity.Property(e => e.NOTAS).HasColumnName("NOTAS");
            entity.Property(e => e.CONSIDERACOES).HasColumnName("CONSIDERACOES");
            entity.Property(e => e.SUBCATEGORIA).HasColumnName("SUBCATEGORIA");
            entity.Property(e => e.DATA_REGISTRO).HasColumnName("DATA_REGISTRO");

            // Relacionamentos
            entity.HasOne(e => e.PrioridadeAtual)
                .WithMany()
                .HasForeignKey(e => e.PRIOR_ATUAL)
                .HasConstraintName("FK_CENARIO_PRIORIDADE_ATUAL");

            entity.HasOne(e => e.StatusAtual)
                .WithMany()
                .HasForeignKey(e => e.STATUS_ATUAL)
                .HasConstraintName("FK_CENARIO_STATUS_ATUAL");

            entity.HasOne(e => e.SubcategoriaNav)
                .WithMany()
                .HasForeignKey(e => e.SUBCATEGORIA)
                .HasConstraintName("FK_CENARIO_SUBCATEGORIA");
        });

        // Mapeamento para CenarioFuturo
        ...
        // Mapeamentos adicionais para outras entidades 
